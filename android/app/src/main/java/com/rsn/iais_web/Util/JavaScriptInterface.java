...
public class JavaScriptInterface {
    ...
    private void convertBase64StringToPdfAndStoreIt(String base64PDf) throws IOException {
        ...
        final File dwldsPath = new File(Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_DOWNLOADS) + "/IAIS_sert_" + timeStamp + "_.pdf");
        Log.e("arsen", "convertBase64StringToPdfAndStoreIt: "+Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_DOWNLOADS) + "/IAIS_sert_" + timeStamp + "_.pdf");
        ...
        Log.e("arsen", "convertBase64StringToPdfAndStoreIt: sebelum if");
        if (dwldsPath.exists()) {
